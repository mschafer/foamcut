...
__attribute__( ( always_inline ) ) uint32_t USB_ReqSetClrFeature(uint32_t sc) {
    uint32_t n, m;
...
__attribute__( ( always_inline ) ) uint32_t USB_ReqSetAddress(void) {
...
__attribute__( ( always_inline ) ) uint32_t USB_ReqGetDescriptor(void) {
    uint8_t *pD;
    uint32_t len, n;
...
__attribute__( ( always_inline ) ) uint32_t USB_ReqGetConfiguration(void) {
...
__attribute__( ( always_inline ) ) uint32_t USB_ReqSetConfiguration(void) {
...
__attribute__( ( always_inline ) ) uint32_t USB_ReqGetInterface(void) {
...
__attribute__( ( always_inline ) ) uint32_t USB_ReqSetInterface(void) {
    USB_COMMON_DESCRIPTOR *pD;
